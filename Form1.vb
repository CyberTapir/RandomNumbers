...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        method1()
        s.Stop()
        ListBox1.Items.Add(s.ElapsedMilliseconds / 10 & " seconds " & "m1")
        initArray()
        s.Reset()
        s.Start()
        method2()
        s.Stop()
        ListBox1.Items.Add(s.ElapsedMilliseconds / 10 & " seconds " & "m2")
        initArray()
        s.Reset()
        s.Start()
        method3()
        s.Stop()
        ListBox1.Items.Add(s.ElapsedMilliseconds / 10 & " seconds " & "m3")
    End Sub
